...
var _fizwidget$wikipedia_game$Common_View$toUrl = function (title) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'https://en.wikipedia.org/wiki/',
		_fizwidget$wikipedia_game$Common_Title_Model$value(title));
};
var _fizwidget$wikipedia_game$Common_View$viewLink = function (title) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$a,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$href(
				_fizwidget$wikipedia_game$Common_View$toUrl(title)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _fizwidget$wikipedia_game$Common_View$viewArticleError = function (error) {
	...
	function (source, destination, stops) {
		return A2(
			...
			A2(
				...
				A2(_elm_lang$core$List$map, _fizwidget$wikipedia_game$Common_View$viewLink, stops)));
	});
...
var _fizwidget$wikipedia_game$Pathfinding_Util$matchWord = function (target) {
		...
		return _elm_lang$core$Native_Utils.eq(title, destination.title) ? 1000 : _elm_lang$core$Basics$toFloat(
			_elm_lang$core$List$length(
				A3(
					...
					_elm_lang$core$Regex$All,
					_fizwidget$wikipedia_game$Pathfinding_Util$matchWord(
						_fizwidget$wikipedia_game$Common_Title_Model$value(title)),
					destination.content)));
	});
...
var _fizwidget$wikipedia_game$Pathfinding_Util$addLinks = F4(
...
var _fizwidget$wikipedia_game$Pathfinding_Update$hasReachedDestination = F2(
	function (pathSoFar, destination) {
		return _elm_lang$core$Native_Utils.eq(pathSoFar.next, destination.title);
	});
...
var _fizwidget$wikipedia_game$Pathfinding_Update$destinationReached = F2(
	function (_p1, destinationToSource) {
		var _p2 = _p1;
		return A3(
			_fizwidget$wikipedia_game$Finished_Init$init,
			_p2.source.title,
			_p2.destination.title,
			_elm_lang$core$List$reverse(
...
var _fizwidget$wikipedia_game$Pathfinding_Update$followPath = F2(
	function (model, pathToFollow) {
		return A2(_fizwidget$wikipedia_game$Pathfinding_Update$hasReachedDestination, pathToFollow, model.destination) ? A2(_fizwidget$wikipedia_game$Pathfinding_Update$destinationReached, model, pathToFollow) : {
			ctor: '_Tuple2',
...
var _fizwidget$wikipedia_game$Pathfinding_Update$updateWithArticle = F3(
	function (model, pathSoFar, article) {
		var updatedPriorityQueue = A4(_fizwidget$wikipedia_game$Pathfinding_Util$addLinks, model.priorityQueue, model.destination, pathSoFar, article.links);
		var updatedModel = _elm_lang$core$Native_Utils.update(
			model,
			{priorityQueue: updatedPriorityQueue});
		return _fizwidget$wikipedia_game$Pathfinding_Update$followHighestPriorityPath(updatedModel);
...
var _fizwidget$wikipedia_game$Pathfinding_Update$update = F2(
	function (message, model) {
		var _p4 = message;
		if (_p4.ctor === 'FetchArticleResponse') {
			var _p5 = _p4._1;
			if (_p5.ctor === 'Ok') {
				return A3(_fizwidget$wikipedia_game$Pathfinding_Update$updateWithArticle, model, _p4._0, _p5._0);
			} else {
				return A2(_fizwidget$wikipedia_game$Pathfinding_Update$updateWithError, model, _p5._0);
			}
		} else {
			return _fizwidget$wikipedia_game$Setup_Init$init;
		}
...
var _fizwidget$wikipedia_game$Setup_View$getErrorMessage = function (remoteArticle) {
	...
	if (_p0.ctor === 'Failure') {
		return _fizwidget$wikipedia_game$Common_View$viewArticleError(_p0._0);
	} else {
...
var _fizwidget$wikipedia_game$Setup_View$showSpinnerIfLoading = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _fizwidget$wikipedia_game$Common_View$viewSpinner(
				_fizwidget$wikipedia_game$Setup_View$isLoading(model)),
			_1: {ctor: '[]'}
		});
};
...
var _fizwidget$wikipedia_game$Pathfinding_View$stopView = function (title) {
	return A2(
		...
		{
			ctor: '::',
			_0: _fizwidget$wikipedia_game$Common_View$viewLink(title),
			_1: {ctor: '[]'}
		});
};
...
var _fizwidget$wikipedia_game$Pathfinding_View$errorsView = function (errors) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _fizwidget$wikipedia_game$Common_View$viewArticleError, errors));
};
