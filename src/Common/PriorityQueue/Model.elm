...
removeHighestPriorities priorityQueue count =
    removeHighestPrioritiesInternal priorityQueue count []
...
removeHighestPrioritiesInternal priorityQueue count values =
    if count > 0 then
        let
            ( value, updatedPriorityQueue ) =
                removeHighestPriority priorityQueue
        in
            removeHighestPrioritiesInternal updatedPriorityQueue (count - 1) (value :: values)
    else
